...
//checking rows
for(int i=0; i<SIDE; i++){
    if(board[0][i]==COMPUTER_SYMBOL && board[1][i]==COMPUTER_SYMBOL && board[3][i] == ' '){
        return (6+i);
    }
}
for(int i=0; i<SIDE; i++){
...
else if(board[0][2]==COMPUTER_SYMBOL && board[0][2]==board[1][1] && board[0][2]==' '){
    return 7;
}
...
//checking rows
for(int i=0; i<SIDE; i++){
    if(board[0][i]==PLAYER1_SYMBOL && board[1][i]==PLAYER1_SYMBOL && board[3][i] == ' '){
        return (6+i);
    }
}
for(int i=0; i<SIDE; i++){
...
else if(board[0][2]==PLAYER1_SYMBOL && board[0][2]==board[1][1] && board[0][2]==' '){
    return 7;
}
