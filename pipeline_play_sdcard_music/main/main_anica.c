...
//#include "play_sdcard_music_example.h"
...
void processing_buffer(void * params)
{
    while(1) 
    {
        ...
        const char * file = "/sdcard/text.txt";
        // funct here
        //s_example_write_file(file, (char *)song_buffer.buffer[processBuffer]);
